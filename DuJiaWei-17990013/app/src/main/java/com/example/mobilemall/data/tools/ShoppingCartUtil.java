...
public class ShoppingCartUtil {
     ...
     * 添加购物车
     */
    public static void addShoppingCart(Item item) {
        ShoppingCart shoppingCart = MallDataBase.mallDataBase.shoppingCartDao().findItem(Constant.account.uid, item.uuid);
     ...
     * 更新商品在购物车中的数量
     */
    public static void setShoppingCart(Item item, int count) {
        if (count == 0) {
            //设置数量为0，从购物车移除商品
